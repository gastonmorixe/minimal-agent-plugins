...
The id (e.g. `#mp0sf575-bee2`) is the bullet's stable identifier, and the agent reading your summary can call `MemoryTool({action:"read", id})` to fetch the full body.
